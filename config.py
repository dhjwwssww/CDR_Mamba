...
# parser.add_argument('--gpu_id', type=list, default=[0, 1, 2], help='use cpu only')
...
parser.add_argument('--dataset_path',default = r'/home/zxk/skull/data125/new_registed/datasetA/',help='fixed trainset root path')



parser.add_argument('--test_data_path',default = '/ssd/lzq/dataset/LiTS/test',help='Testset path')
parser.add_argument('--save',default='100-25-ceshi-A-1',help='save path of trained model')
...
# parser.add_argument('--lr', type=float, default=0.00005, metavar='LR',help='learning rate (default: 0.0001)')
parser.add_argument('--lr', type=float, default=0.0002, metavar='LR',help='learning rate (default: 0.0002)')
parser.add_argument('--early-stop', default=300, type=int, help='early stopping (default: 30)')
